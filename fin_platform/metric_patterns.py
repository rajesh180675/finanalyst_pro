...
METRIC_DEFS: Dict[str, PatternDef] = {
    ...
    "Other Short-term Financial Assets": PatternDef("BalanceSheet", ["other short term financial assets", "other short-term financial assets", "other financial assets current"], ["non-current"], priority=5),
    "Assets Held for Sale": PatternDef("BalanceSheet", ["assets held for sale", "non-current assets held for sale"], priority=5),
    ...
    "Current Tax Liabilities": PatternDef("BalanceSheet", ["current tax liabilities", "current tax liability", "income tax payable", "current tax payable"], ["deferred"], priority=5),
    "Other Short-term Liabilities": PatternDef("BalanceSheet", ["other short term liabilities", "other short-term liabilities"], ["non-current"], priority=4),
    "Liabilities Held for Sale": PatternDef("BalanceSheet", ["liabilities held for sale", "liability directly associated with assets held for sale"], priority=5),
